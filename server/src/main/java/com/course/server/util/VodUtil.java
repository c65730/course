...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI4GJTep3Wb8YEZcffKxBK";
        //您的AccessKeySecret
        String accessKeySecret = "lAr28sHZvZ5nM3bkKtf2N4AnVuRDRg";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "D:\\tools\\imooc\\course\\course\\gVf7k6rT.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
